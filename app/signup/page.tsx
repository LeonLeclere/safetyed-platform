      ...
      <div style={{
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div style={{ position: 'relative' }} ref={dropdownRef}>
                <input
                  ...
                  style={{
                    ...inputStyle,
                    paddingRight: selectedSchool ? '40px' : '14px',
                    borderColor: selectedSchool ? '#22c55e' : '#2a2d3a',
                  }}
                  autoComplete="off"
                />
                  ...
                  <div style={{
                    ...
                    {schools.map(school => (
                      ...
                      >
                        ...
                        {school.region && (
                          <span style={{ fontSize: '12px', color: '#6b7280' }}>{school.region}</span>
                        )}
                      </button>
                    ))}
                  </div>
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                placeholder="jordan.m@eq.edu.au"
                style={inputStyle}
                autoComplete="email"
              />
            </div>
          ...
          <div style={{
            ...
            🔒 QLD Privacy Compliant — We store: first name, last initial, year level, and school email only. No full names, dates of birth, or addresses.
          </div>

          {/* Login link */}
          <div style={{ textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#6b7280' }}>
            Already have an account?{' '}
            <a href="/login" style={{ color: '#f97316', textDecoration: 'none', fontWeight: 600 }}>
              Log in
            </a>
          </div>
